...
- *(Note: Initial Supabase migration codebase was lost/removed during cleanup; a fresh migration is scheduled to bring the platform to modern serverless infrastructure.)*
...
---
*Document version 3.0. Prepared by TechNova Group / GrainHero team, July 2026.*
