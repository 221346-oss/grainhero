...
_RPN = Risk Priority Number = Severity × Probability × Detection (normalized scale)_
...
_Risk levels reviewed 2026-07-10. Re-review required after Sprint 1 and before commercial launch._
