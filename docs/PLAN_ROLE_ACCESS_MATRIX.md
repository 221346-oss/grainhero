...
1. **Subscription Plan** — determines what *features and resource limits* are available to an entire tenant (admin + their team).
2. **User Role** — determines what *actions* a specific user can perform within their tenant's plan.
