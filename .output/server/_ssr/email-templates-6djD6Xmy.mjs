//#region node_modules/.nitro/vite/services/ssr/assets/email-templates-6djD6Xmy.js
function escapeHtml(s) {
	return String(s).replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#39;");
}
var emailWrapper = (content) => `
<!DOCTYPE html>
<html>
...
function welcomeEmailHTML(firstName, dashboardUrl) {
	return emailWrapper(`
...
function day3EmailHTML(firstName, siloCount, analyticsUrl) {
	return emailWrapper(`
...
function day10EmailHTML(firstName, siloCount, storageGB, featuresUrl) {
	return emailWrapper(`
...
function trialEndingEmailHTML(firstName, daysLeft, pricingUrl) {
	return emailWrapper(`
...
function reengagementEmailHTML(firstName, siloCount, storageGB, loginUrl) {
	return emailWrapper(`
...
//#endregion
export { welcomeEmailHTML as a, trialEndingEmailHTML as i, day3EmailHTML as n, reengagementEmailHTML as r, day10EmailHTML as t };
