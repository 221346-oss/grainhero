	...
	open(onMessage, onDisconnect) {
		...
		try {
			...
			if (isNodeSdk()) {
				...
				options = { headers: {
					"User-Agent": `Firebase/${PROTOCOL_VERSION}/${SDK_VERSION}/${processModule.platform}/${device}`,
...
function repoManagerDatabaseFromApp(app, authProvider, appCheckProvider, url, nodeAdmin) {
	...
	if (typeof processModule !== "undefined" && processModule.env) dbEmulatorHost = processModule.env[FIREBASE_DATABASE_EMULATOR_HOST_VAR];
	if (dbEmulatorHost) {
		isEmulator = true;
...
registerDatabase();
//#endregion
export { ref as i, off as n, onValue as r, getDatabase as t };
