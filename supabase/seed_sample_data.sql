...
VALUES
  ...
  ('eeeeeeee-0000-4000-8000-000000000005', 'SILO-DEMO-005', 'Silo C1 — Barley',
   ...
   'aaaaaaaa-0000-4000-8000-000000000003'),
  ('eeeeeeee-0000-4000-8000-000000000006', 'SILO-DEMO-006', 'Silo A3 — Sorghum',
   'aaaaaaaa-0000-4000-8000-000000000001', 'dddddddd-0000-4000-8000-000000000001', 200000, 75000,
   'aaaaaaaa-0000-4000-8000-000000000001'),
  ('eeeeeeee-0000-4000-8000-000000000007', 'SILO-DEMO-007', 'Silo B3 — Cotton Seed',
   'aaaaaaaa-0000-4000-8000-000000000002', 'dddddddd-0000-4000-8000-000000000002', 400000, 280000,
   'aaaaaaaa-0000-4000-8000-000000000002')
ON CONFLICT (id) DO NOTHING;
