-- Fix auto_provision_from_install: use location jsonb instead of non-existent
-- address_line1/city/country columns, and generate unique alphabetical silo names
-- per warehouse (Silo A, Silo B, … Silo Z, Silo AA, …) matching the TypeScript logic.
