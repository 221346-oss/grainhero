      ...
      if (wantsEmail && process.env.RESEND_API_KEY) {
        ...
        const html = `
          <div style="font-family:Inter,sans-serif;color:#0f172a;">
            ...
            <p><a href="${requireAppOrigin().replace(/\/$/, "")}/subscription" style="background:#059669;color:#fff;padding:10px 18px;border-radius:8px;text-decoration:none;">Manage subscription</a></p>
