...
function GrainStorageMonitoringPage() {
  return (
    <MarketingPage
      ...
      crumbs={[{ label: "Home", to: "/" }, { label: "Grain storage monitoring" }]}
    >
      <Section heading="Why manual checks miss the early stage">
        <p>
          Spoilage starts as a localised pocket. Respiring grain, insects and mould all release heat
          and moisture, and because a grain mass is an excellent insulator, that heat stays
          concentrated instead of dissipating. By the time a hot spot is warm enough to notice from
          the surface or from a single probe sample, the affected volume has usually grown well past
          the point where aeration alone will fix it.
        </p>
        <p>
          ...
          by the FAO, with storage a significant share of that. The measurable part of the problem —
          temperature and moisture drift — is exactly what a sensor network is good at.
        </p>
      </Section>
      ...
      <Section heading="Safe ranges are grain-specific">
        <p>
          ...
          storage, and every point of moisture above that ceiling shortens safe storage life sharply
        ...
        />
        <p>
          The full breakdown, including aeration timing and the warning signs to look for, is in the{" "}
          <a
            className="font-medium text-[#2FA84F] underline underline-offset-2"
            href="/guides/grain-storage"
          >
            grain storage guide
          </a>
          .
      ...
      <Section heading="From reading to action">
        ...
        <ol className="ml-5 list-decimal space-y-2">
          ...
          <li>
            <strong className="text-[#111512]">Trend detection.</strong> A point warming faster than
            its neighbours is flagged, not just a point crossing an absolute limit — drift matters
            more than a single number.
          </li>
          <li>
            <strong className="text-[#111512]">Prediction.</strong> A model trained on storage
            histories scores each batch for spoilage risk so attention goes to the batch most likely
            to fail next, not the one that already failed.
          </li>
          <li>
