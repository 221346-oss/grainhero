  ...
  return (
    ...
    >
      ...
      <Section heading="Installation and tracking">
        <p>
          Hardware is ordered through your account. Each order carries the structures it covers,
          and once scheduled it shows the assigned technician, the install date and the city and
          site. After commissioning, every device stays linked to the silo it was installed in, so
          the same record answers both &quot;where is my order&quot; and &quot;which sensor is
          reporting this reading&quot;. Managers see the full trail from their installation orders
          page.
        </p>
      </Section>
      ...
      <Section heading="Keep reading">
        <NextSteps
          links={[
            ...
            { to: '/contact', label: 'Request a site survey', note: 'Get a layout for your structures.' },
          ]}
        />
      </Section>
    </MarketingPage>
