              ...
              >
                ...
                <div className="flex flex-wrap items-center gap-3.5 mt-1 sm:mt-0">
                  <div className="flex items-center gap-3 text-xs">
                    <span>
                      <span className="font-semibold text-foreground">{t.team_size}</span>{" "}
                      <span className="text-muted-foreground">users</span>
                    </span>
                    <span>
                      <span className="font-semibold text-foreground">{t.batch_count}</span>{" "}
                  ...
                  <div className="flex items-center gap-1.5 shrink-0">
                    ...
                    {t.subscription_plan && (
                      <Badge
                        variant="outline"
                        className="bg-muted text-foreground border-border/40 text-[10px]"
                      >
                        {t.subscription_plan}
                      </Badge>
                    )}
