  ...
  head: () => ({
    meta: [
      { title: "Platform · Insurance · Claims · ClaimId — Grain Hero" },
      {
        name: "description",
        content:
          "Platform · Insurance · Claims · ClaimId workspace in the Grain Hero platform — private, sign-in required.",
      },
      { property: "og:title", content: "Platform · Insurance · Claims · ClaimId — Grain Hero" },
      {
        property: "og:description",
        content: "Platform · Insurance · Claims · ClaimId workspace in the Grain Hero platform.",
      },
