  ...
  head: () => ({
    meta: [
      { title: "Security Center — Grain Hero" },
      {
        name: "description",
        content:
          "Security Center workspace in the Grain Hero platform — private, sign-in required.",
      },
      { property: "og:title", content: "Security Center — Grain Hero" },
      {
        property: "og:description",
        content: "Security Center workspace in the Grain Hero platform.",
      },
...
function SecurityCenterPage() {
  ...
  if (roleQ.isLoading)
    return (
      <AdminPageShell title="Security Center" subtitle="Loading...">
