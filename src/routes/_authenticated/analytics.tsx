...
export const Route = createFileRoute("/_authenticated/analytics")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Analytics workspace in the Grain Hero platform — private, sign-in required.",
      },
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 space-y-6">
          ...
          columns={[
            ...
            },
            {
              ...
              render: (r) => (
                <span
                  className={
                    r.spoilageRate > 0.1 ? "text-red-600 dark:text-red-400 font-medium" : ""
                  }
                >
      ...
      <PageHeader
        ...
        subtitle="Operational and financial performance across your grain operations."
      />
        ...
        <Card>
          <CardContent className="p-4 flex items-center justify-between">
            <div>
              ...
              <div className="text-2xl font-bold text-foreground">{fmtKg(t?.totalKg ?? 0)}</div>
              <div className="text-xs text-muted-foreground mt-1">{t?.batches ?? 0} batches</div>
            </div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4 flex items-center justify-between">
            <div>
              <div className="text-xs uppercase text-muted-foreground font-semibold">Revenue</div>
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <Card>
          ...
          <CardContent className="space-y-3">
              ...
              return (
                <div key={g.grain}>
                  <div className="flex justify-between text-sm mb-1">
                    <span className="capitalize font-medium text-foreground">{g.grain}</span>
            ...
            {byGrain.length === 0 && (
              <div className="text-sm text-muted-foreground text-center py-6">No batches yet.</div>
            )}
          </CardContent>
        </Card>
