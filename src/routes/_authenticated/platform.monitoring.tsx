        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {[0, 1, 2, 3].map((i) => (
              <div
                key={i}
                className="rounded-2xl bg-card/50 p-4 flex flex-col items-center gap-2 relative"
              >
                    ...
                    {maints.map((r) => (
                      ...
                      >
                        ...
                        <td className="px-3 py-2 hidden sm:table-cell">
                          <span className="capitalize text-[11px] px-1.5 py-0.5 rounded text-muted-foreground">
                            {r.priority}
                          </span>
                        </td>
