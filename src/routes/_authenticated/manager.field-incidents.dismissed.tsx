...
export const Route = createFileRoute("/_authenticated/manager/field-incidents/dismissed")({
  head: () => ({ meta: [{ title: "Manager · Dismissed Incidents — Grain Hero" }, { name: "robots", content: "noindex, nofollow" }] }),
