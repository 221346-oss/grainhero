  ...
  head: () => ({
    meta: [
      { title: "Insurance Policies · PolicyId · Documents — Grain Hero" },
      {
        name: "description",
        content:
          "Insurance Policies · PolicyId · Documents workspace in the Grain Hero platform — private, sign-in required.",
      },
      { property: "og:title", content: "Insurance Policies · PolicyId · Documents — Grain Hero" },
      {
        property: "og:description",
        content: "Insurance Policies · PolicyId · Documents workspace in the Grain Hero platform.",
      },
      ...
      {policy && (
        <Card>
          <CardContent className="p-4 text-sm flex flex-wrap items-center gap-4">
            <div>
              <span className="text-muted-foreground text-xs uppercase">Policy #</span>{" "}
              <span className="font-mono">{policy.policy_number ?? policy.id.slice(0, 8)}</span>
            </div>
            <div>
              <span className="text-muted-foreground text-xs uppercase">Product</span>{" "}
              {policy.product?.name ?? "—"}
            </div>
            <div>
              <span className="text-muted-foreground text-xs uppercase">Carrier</span>{" "}
              {policy.product?.carrier?.name ?? "—"}
            </div>
