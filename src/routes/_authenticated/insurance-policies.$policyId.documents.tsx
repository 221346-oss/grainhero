      ...
      {policy && (
        <Card>
          <CardContent className="p-4 text-sm flex flex-wrap items-center gap-4">
            <div>
              <span className="text-slate-500 text-xs uppercase">Policy #</span>{" "}
              <span className="font-mono">{policy.policy_number ?? policy.id.slice(0, 8)}</span>
            </div>
            <div>
              <span className="text-slate-500 text-xs uppercase">Product</span>{" "}
              {policy.product?.name ?? "—"}
            </div>
            <div>
              <span className="text-slate-500 text-xs uppercase">Carrier</span>{" "}
