...
export const Route = createFileRoute("/_authenticated/platform/field-incidents/resolved")({
  head: () => ({ meta: [{ title: "Platform · Resolved Incidents — Grain Hero" }, { name: "robots", content: "noindex, nofollow" }] }),
