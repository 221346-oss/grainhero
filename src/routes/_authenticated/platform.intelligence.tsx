      ...
      >
        <div className="p-4 grid grid-cols-3 gap-4 text-center">
          <div>
            ...
            <div className="text-xs text-slate-500 mt-1">Remote API</div>
          </div>
          <div>
            <div className="text-2xl font-bold text-sky-700">{bySource?.python_local ?? 0}</div>
            <div className="text-xs text-slate-500 mt-1">Local Python fallback</div>
          </div>
          <div>
            <div className="text-2xl font-bold text-red-700">{bySource?.cascade_failed ?? 0}</div>
            <div className="text-xs text-slate-500 mt-1">Both failed</div>
          </div>
        </div>
      </AdminDataCard>
