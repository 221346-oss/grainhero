...
export const Route = createFileRoute("/_authenticated/manager/field-incidents/all")({
  head: () => ({ meta: [{ title: "Manager · All Incidents — Grain Hero" }, { name: "robots", content: "noindex, nofollow" }] }),
