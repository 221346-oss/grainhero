...
function ClaimTimelinePage() {
  ...
  return (
    <div className="min-h-screen p-4 sm:p-6 space-y-6 bg-gradient-to-br from-slate-50 via-white to-emerald-50/30">
      ...
      <div>
        <h1 className="text-2xl sm:text-3xl font-black tracking-tight text-foreground">Claim timeline</h1>
      ...
      {isLoading ? (
        ...
        <Card><CardContent className="p-8 text-center text-muted-foreground">Claim not found or you don't have access.</CardContent></Card>
      ) : (
        <div className="grid gap-6 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2 space-y-6">
            <Card>
              ...
              <CardContent>
                {events.length === 0 ? (
                  <div className="text-muted-foreground text-sm py-8 text-center">No events yet.</div>
                ) : (
                    ...
                    {events.map((e) => (
                      <li key={e.id} className="ml-6">
                        ...
                        <div className="flex items-start gap-2">
                          <div className="mt-0.5">{EVENT_ICON[e.event_type] ?? <MessageSquare className="h-4 w-4 text-muted-foreground" />}</div>
            ...
            <Card>
              ...
              <CardContent>
                {attachments.length === 0 ? (
                  <div className="text-muted-foreground text-sm text-center py-6">No attachments uploaded.</div>
                ) : (
