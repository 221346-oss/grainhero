              ...
              {policiesLoading ? (
                ...
                <div className="divide-y divide-border">
                  {policies.map((p) => (
                    <div
                      key={p.id}
                      className="flex flex-wrap items-center justify-between gap-4 p-4 hover:bg-muted/30 transition-colors bg-card"
                    >
                      ...
                      <div className="text-sm font-semibold text-foreground">
                        ...
                        PKR {(p.premium_amount ?? 0).toLocaleString()}
                      </div>
                      <Badge
                  ...
                  {claims.map((c) => (
                    ...
                    >
                      ...
                      <div className="text-sm font-semibold text-foreground">
                        ...
                        PKR {(c.amount_claimed ?? 0).toLocaleString()}
                      </div>
                      <div className="text-sm font-semibold text-foreground">
                        <span className="text-xs font-normal text-muted-foreground block">
                          Approved
