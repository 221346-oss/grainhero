  ...
  head: () => ({
    meta: [
      { title: "Platform · Finance · Tax Rules — Grain Hero" },
      {
        name: "description",
        content:
          "Platform · Finance · Tax Rules workspace in the Grain Hero platform — private, sign-in required.",
      },
      { property: "og:title", content: "Platform · Finance · Tax Rules — Grain Hero" },
      {
        property: "og:description",
        content: "Platform · Finance · Tax Rules workspace in the Grain Hero platform.",
      },
...
function TaxRulesPage() {
  ...
  const [form, setForm] = useState<{
    region: string;
    ratePct: number;
    ruleType: "vat" | "gst" | "sales" | "withholding";
    appliesTo: "buyer" | "seller" | "platform_fee";
  }>({
    region: "",
    ratePct: 0,
    ruleType: "vat",
          ...
          <CardContent className="grid grid-cols-1 md:grid-cols-5 gap-3">
            ...
            <div>
              ...
              <select
                value={form.ruleType}
                onChange={(e) =>
                  setForm({ ...form, ruleType: e.target.value as typeof form.ruleType })
                }
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setForm({ ...form, appliesTo: e.target.value as typeof form.appliesTo })
                }
                className="h-9 w-full rounded-md border bg-background px-2 text-sm"
              >
