...
export const Route = createFileRoute("/_authenticated/actuators")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Actuators workspace in the Grain Hero platform — private, sign-in required.",
      },
...
function ActuatorsPage() {
  ...
  const control = useMutation({
    mutationFn: (v: { id: string; action: string; value?: number }) => ctrlFn({ data: v } as never),
    onSuccess: (_d, v) => {
  ...
  const openEdit = (r: Actuator) => {
    setForm({
      ...
      status: r.status,
      control_mode: (r.control_mode as Form["control_mode"]) ?? "auto",
                    ...
                    <span className="flex items-center gap-2 min-w-0">
                      ...
                      >
                        <Icon
                          ...
                          style={
                            on && r.actuator_type === "fan" ? { animationDuration: "1.2s" } : {}
                          }
                        />
                      </div>
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => setForm({ ...form, target_fan_speed: e.target.value })}
              />
            </div>
            ...
            <>
              <DialogHeader>
                <DialogTitle className="flex items-center gap-2">
                  {(() => {
                    const I = typeIcon(viewing.actuator_type);
