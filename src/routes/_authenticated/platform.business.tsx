            ...
            <div className="rounded-2xl bg-card/50 overflow-hidden">
              <div className="px-5 py-3.5 border-b flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span
                    title="Revenue from silo hardware orders, tracked separately from subscription MRR"
          ...
          <div className="rounded-2xl bg-card/50 overflow-hidden">
            <div className="px-5 py-3.5 border-b flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span
                  title="Click a plan row to filter and show its subscribers below"
              ...
              <div className="p-4 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3">
                {filteredSubs.map((a, i) => {
                  ...
                  return (
                    <div
                      key={i}
                      className="rounded-2xl bg-card/50 px-3.5 py-3 transition-colors hover:bg-muted/20"
                    >
