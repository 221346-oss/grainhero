...
function MyOrdersPage() {
  ...
  // Redirect managers away from this page
  if (userRole === "manager") {
      ...
      >
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              One-time hardware &amp; install fee for one additional silo beyond your plan's
              included limit. We'll charge you now and dispatch a technician to install it.
            </DialogDescription>
          </DialogHeader>
          <form
            ...
            onSubmit={(e) => {
              e.preventDefault();
              // Close form dialog and show confirmation dialog
              setAddonOpen(false);
