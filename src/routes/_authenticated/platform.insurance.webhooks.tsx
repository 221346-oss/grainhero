        ...
        <SheetContent className="w-[560px] sm:max-w-[560px] overflow-y-auto">
          ...
          {detail && (
            <div className="space-y-4 mt-4 text-sm">
              ...
              <div>
                <span className="text-slate-500">Event:</span> {detail.event_type}
              </div>
              <div>
                <span className="text-slate-500">External ID:</span> {detail.external_id ?? "—"}
              </div>
...
function StatTile({
  ...
  const cls =
    tone === "red" ? "text-red-600" : tone === "emerald" ? "text-emerald-600" : "text-slate-700";
  return (
    <Card>
