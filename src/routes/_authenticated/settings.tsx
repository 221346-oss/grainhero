...
export const Route = createFileRoute("/_authenticated/settings")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Settings workspace in the Grain Hero platform — private, sign-in required.",
      },
...
type Prefs = {
  ...
  expiry_email_alerts?: boolean;
  expiry_push_alerts?: boolean;
};
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Square image works best. Save to apply.
                  </p>
                </div>
                <input
                  ref={fileRef}
        ...
        <TabsContent className="max-w-md" value="appearance">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Pick a color theme. Applies to the whole app instantly and is remembered on this
                device.
              </CardDescription>
            </CardHeader>
            <CardContent>
    ...
    <div className="space-y-4">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            When on, tenant apps can display a maintenance notice. Reads
            platform_settings.config.maintenance_mode.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="flex items-center justify-between rounded-lg border-border/40 p-3">
            ...
            <Switch
              ...
              onCheckedChange={(v) => setCfg({ ...cfg, maintenance_mode: v })}
            />
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Boolean flags any part of the app can read. Toggle to enable or disable a feature
            platform-wide.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-3">
          ...
          {Object.entries(cfg.feature_flags).map(([k, v]) => (
            <div
              key={k}
              className="flex items-center justify-between rounded-lg border-border/40 p-3"
            >
              ...
              <div className="flex items-center gap-2">
                <Switch
                  ...
                  onCheckedChange={(next) =>
                    setCfg({ ...cfg, feature_flags: { ...cfg.feature_flags, [k]: next } })
                  }
                />
                <Button
                  size="icon"
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Baseline numeric thresholds (e.g. spoilage_risk, humidity_alert). Tenants can override
        ...
        <CardContent className="space-y-3">
          ...
          {Object.entries(cfg.default_thresholds).map(([k, v]) => (
            <div
              key={k}
              className="flex items-center justify-between gap-3 rounded-lg border-border/40 p-3"
            >
              ...
              <Input
                ...
                onChange={(e) =>
                  setCfg({
                    ...cfg,
                    default_thresholds: { ...cfg.default_thresholds, [k]: Number(e.target.value) },
                  })
                }
                className="w-32"
              />
    ...
    <>
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Silo hardware SKUs shown to admins when they request a new silo. Prices in PKR. Changes
      ...
      >
        <SheetContent className="sm:max-w-sm">
          <SheetHeader>
            ...
            <SheetDescription>
              {isNew
                ? "New SKU shown to admins on the Request Silo page."
                : "Update this SKU. Changes apply after saving settings."}
            </SheetDescription>
          </SheetHeader>
          {draft && (
            <div className="mt-6 space-y-4">
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  placeholder="e.g. Standard Silo Kit"
                  autoFocus
                />
              </div>
              <div className="space-y-1.5">
              ...
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  onChange={(e) => setDraft({ ...draft, price_pkr: Number(e.target.value) })}
                  placeholder="2300000"
                />
                {draft.price_pkr > 0 && (
                  <p className="text-[10px] text-muted-foreground">
                    = PKR {fmtPKR(draft.price_pkr)}
                  </p>
                )}
              </div>
            </div>
