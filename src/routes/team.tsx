  ...
  head: () => ({
    meta: [
      { title: "Our Team — GrainHero" },
      {
        name: "description",
        content:
          "Meet the founders and team behind GrainHero's innovative grain storage solutions.",
      },
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <p className="text-xl text-[#EDE9D4]/80 leading-relaxed">
              A passionate team dedicated to revolutionizing grain storage with cutting-edge
              technology
            </p>
          </motion.div>
        </div>
