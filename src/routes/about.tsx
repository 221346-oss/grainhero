  ...
  head: () => ({
    meta: [
      { title: "About Us — GrainHero" },
      {
        name: "description",
        content:
          "Learn about GrainHero's mission to revolutionize grain storage with AI-powered technology.",
      },
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <p className="text-xl text-[#EDE9D4]/80 leading-relaxed">
              Revolutionizing grain storage with AI-powered technology to protect harvests and
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
            ...
            >
              ...
              <p className="text-[#404F44] text-lg leading-relaxed">
                To eliminate grain spoilage and post-harvest losses by providing farmers and grain
                operators with intelligent, accessible, and affordable IoT monitoring solutions
            ...
            >
              ...
              <p className="text-[#404F44] text-lg leading-relaxed">
                A world where no grain is lost to preventable spoilage. Where every farmer has
                access to enterprise-grade technology that protects their harvest and maximizes
                their livelihood.
              </p>
            </motion.div>
          </div>
          ...
          >
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-[#2FAC0C]/10">
              <p className="text-[#404F44] leading-relaxed mb-4">
                GrainHero was born from a simple observation: billions of dollars worth of grain are
                lost every year to spoilage, despite existing technology that could prevent it.
              </p>
              <p className="text-[#404F44] leading-relaxed mb-4">
                Our founders—combining expertise in agriculture, software engineering, IoT systems,
                and artificial intelligence—came together with a shared mission: make
                enterprise-grade grain monitoring accessible to every farmer, regardless of their
                operation's size.
              </p>
              <p className="text-[#404F44] leading-relaxed mb-4">
                ...
                of bushels of grain, preventing spoilage and protecting livelihoods across
                continents.
              </p>
              <p className="text-[#404F44] leading-relaxed">
                ...
                agriculture, where data drives decisions, and where no harvest is lost to
                preventable causes.
              </p>
            </div>
          </motion.div>
