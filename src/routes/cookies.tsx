  ...
  head: () => ({
    meta: [
      { title: "Cookie Policy — GrainHero" },
      {
        name: "description",
        content:
          "GrainHero Cookie Policy. Read about how we use cookies and manage your preferences.",
      },
  ...
  const sections = [
    {
      ...
      description:
        "Cookies are small text files placed on your device to store data that can be recalled by a web server. We use cookies and similar technologies to store and honor your preferences and settings, enable you to sign in, combat fraud, and analyze how our services perform.",
      points: [
    ...
    },
    {
      ...
      description:
        "These cookies are absolutely necessary for the website to function and cannot be switched off in our systems. They are usually only set in response to actions made by you which amount to a request for services, such as setting your privacy preferences, logging in, or filling in forms.",
      points: [
              ...
              >
                ...
                <ul className="space-y-3 mt-auto">
                  {section.points.map((point, pIdx) => (
                    <li
                      key={pIdx}
                      className="flex items-start gap-2.5 text-xs sm:text-sm text-[#404F44]/90"
                    >
