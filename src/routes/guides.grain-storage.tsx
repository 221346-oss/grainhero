    ...
    >
      <Section heading="On this page">
        <ul className="ml-5 list-disc space-y-1">
          <li><a className="text-[#2FA84F] underline underline-offset-2" href="#moisture">Safe moisture by grain type</a></li>
          <li><a className="text-[#2FA84F] underline underline-offset-2" href="#temperature">Temperature and storage life</a></li>
          <li><a className="text-[#2FA84F] underline underline-offset-2" href="#failure">How storage fails</a></li>
          <li><a className="text-[#2FA84F] underline underline-offset-2" href="#aeration">Aeration: when to run fans</a></li>
          <li><a className="text-[#2FA84F] underline underline-offset-2" href="#checklist">Storage season checklist</a></li>
        </ul>
      </Section>
      ...
      <Section id="moisture" heading="Safe moisture by grain type">
        ...
        <p>
          ...
          storage life at a given temperature, which is why grain that seems fine at 15% in
          November can fail badly by March.
        </p>
      </Section>

      <Section id="temperature" heading="Temperature and storage life">
        <p>
          Temperature sets the speed of everything biological in the mass. The practical
          thresholds:
        </p>
        <DataTable
      ...
      <Section id="failure" heading="How storage fails">
        <ul className="ml-5 list-disc space-y-2">
          ...
          <li>
            <strong className="text-[#111512]">Fines accumulation.</strong> Broken kernels and
            chaff concentrate under the fill point, restricting airflow exactly where aeration is
            most needed. Coring the bin after filling removes most of it.
          </li>
          <li>
            <strong className="text-[#111512]">Insect infestation.</strong> Residual insects in an
            uncleaned bin colonise the new crop immediately. Cleaning between fills is not
            optional.
          </li>
          <li>
      ...
      <Section id="aeration" heading="Aeration: when to run fans">
        <p>
          Aeration is for moving temperature, not for drying wet grain. The decision rule is
          simple in principle: run the fans when the outside air will leave the grain cooler and
          no wetter than it is now.
        </p>
        <ul className="ml-5 list-disc space-y-2">
        ...
        <p>
          Because the rule depends on both ambient and grain conditions at the same instant, it is
          a good candidate for automation — which is what{' '}
          <a className="font-medium text-[#2FA84F] underline underline-offset-2" href="/solutions/grain-storage-monitoring">
      ...
      <Section id="checklist" heading="Storage season checklist">
        <ol className="ml-5 list-decimal space-y-2">
          <li>Clean the structure and the handling equipment before filling; remove old residue.</li>
          <li>Dry incoming grain to its long-term target before it goes in, not after.</li>
          <li>Record intake moisture and grain type per batch, so thresholds are batch-specific.</li>
          <li>Core the bin after filling to pull the fines column out from under the fill point.</li>
          <li>Cool the mass to target with the first suitable ambient window.</li>
          <li>Monitor temperature and moisture at depth; investigate any point that diverges from its neighbours.</li>
          <li>Log every aeration run, treatment and inspection against the batch.</li>
          <li>Re-cool through the season and re-check the top layer for crusting after every cold snap.</li>
        </ol>
      </Section>
