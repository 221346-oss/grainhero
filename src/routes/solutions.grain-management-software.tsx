    ...
    >
      <Section heading="What the platform covers">
        <DataTable
          ...
          rows={[
            ...
            ['Dispatch & sales', 'Outbound loads drawn from batches, with the condition history attached'],
            ['Reports', 'Condition audit trails, inventory positions and financial summaries, exportable'],
          ]}
        />
      </Section>
      ...
      <Section heading="Built around roles, not one giant screen">
        ...
        <ul className="ml-5 list-disc space-y-2">
          <li>
            <strong className="text-[#111512]">Owner / admin</strong> — every site, subscription
            and financial position; where capacity and revenue are going.
          </li>
          <li>
            <strong className="text-[#111512]">Warehouse manager</strong> — their site&apos;s
            silos, batches, open alerts, staff and installation orders.
          </li>
          <li>
            <strong className="text-[#111512]">Technician</strong> — the assigned tasks, the silo
            in question, and the reading history needed to act on it.
          </li>
        </ul>
        <p>
      ...
      <Section heading="Traceability that survives an audit">
        <p>
          Every batch carries a dated history: when it arrived, at what moisture, which silo it
          went into, every condition reading while it was stored, every aeration run and treatment
          applied, and which outbound load it left on. When a buyer or insurer asks how the grain
          was held, that record is the answer, and it can be exported rather than reconstructed
          from memory.
        </p>
      </Section>
      ...
      <Section heading="Keep reading">
        <NextSteps
          links={[
            ...
            { to: '/contact', label: 'Talk to us', note: 'See the platform against your operation.' },
          ]}
        />
      </Section>
    </MarketingPage>
