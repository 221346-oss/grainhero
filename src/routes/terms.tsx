        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <p className="text-lg text-[#404F44] leading-relaxed">
              These Terms of Service ("Terms") govern your access to and use of the GrainHero platform,
              including our website, mobile applications, and related services (collectively, the "Service").
              By using GrainHero, you agree to these Terms. Please read them carefully.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          >
            ...
            <p className="text-[#404F44] leading-relaxed">
              ...
              through the Service. Your continued use of GrainHero after such notification constitutes
          ...
          >
            ...
            <p className="text-[#404F44] leading-relaxed">
              ...
              in which GrainHero operates, without regard to its conflict of law provisions.
            </p>
          </motion.div>
        </div>
      </section>
