      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-[#111512] mb-4">
            Get Started in <span className="text-[#2FA84F]">3 Simple Steps</span>
          </h2>
            ...
            >
              ...
              <div className="flex-1 space-y-4">
                <div className="flex items-center gap-4">
                  <span className="text-6xl sm:text-7xl font-black text-[#2FA84F]">
                    {step.number}
                  </span>
                  <div className="bg-[#2FA84F]/10 p-4 rounded-xl">
                ...
                <ul className="space-y-2 pt-2">
                  {step.details.map((detail, idx) => (
                    <li key={idx} className="flex items-center gap-2 text-[#4A554C]">
                      <CheckCircle className="w-5 h-5 text-[#2FA84F] flex-shrink-0" />
                      <span>{detail}</span>
                    </li>
                  ))}
                </ul>
              ...
              <div className="flex-1 w-full max-w-md">
                <div className="aspect-square bg-white rounded-2xl flex items-center justify-center border-2 border-[#2FA84F]/20 shadow-lg overflow-hidden">
                  ...
                  />
                  <step.icon className="hidden w-24 h-24 text-[#2FA84F]/30" />
                </div>
              </div>
            </motion.div>
          ))}
