    ...
    <section id="faq" className="py-12 sm:py-16 px-4 sm:px-6 lg:px-8 bg-[#FAFAF7]">
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-[#4A554C]">Everything you need to know about GrainHero</p>
        </motion.div>
            ...
            >
              ...
              <AnimatePresence>
                {openIndex === index && (
                  ...
                  >
                    <div className="px-6 pb-5 text-[#4A554C] leading-relaxed">{faq.answer}</div>
                  </motion.div>
                )}
              </AnimatePresence>
            </motion.div>
        ...
        >
          <h3 className="text-xl font-bold text-[#111512] mb-2">Still have questions?</h3>
          <p className="text-[#4A554C] mb-4">Our team is here to help you get started</p>
          <button
            onClick={() => {
