...
export function NewCTASection() {
  return (
    <section className="relative py-14 sm:py-20 overflow-hidden bg-[#252d26]">
      {/* Background Pattern */}
      ...
      {/* Decorative Blobs */}
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#2FAC0C]/10 rounded-full blur-3xl" />
      <div className="absolute bottom-0 right-1/4 w-64 h-64 bg-[#2FAC0C]/10 rounded-full blur-2xl" />
      ...
      <div className="container mx-auto px-4 text-center relative z-10 max-w-5xl">
        ...
        >
          ...
          {/* Heading */}
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-black text-[#EDE9D4] mb-6 leading-tight">
            Ready to Optimize Your
            <br />
            <span className="text-[#2FAC0C]">Grain Storage?</span>
          </h2>

          {/* Description */}
          <p className="text-xl text-[#EDE9D4]/70 mb-10 max-w-3xl mx-auto leading-relaxed">
