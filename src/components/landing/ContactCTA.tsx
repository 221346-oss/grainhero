    ...
    <section className="gh-grain relative bg-[#A8E6A1] px-5 py-24 sm:px-8 sm:py-32">
      ...
      >
        ...
        <div className="mt-10 flex flex-col justify-center gap-3 sm:flex-row">
          ...
          <Link
            to="/marketplace"
            className="inline-flex items-center justify-center rounded-full border-2 border-[#111512]/35 px-9 py-4 text-base font-bold text-[#111512] transition-all duration-300 hover:border-[#111512] hover:bg-[#111512] hover:text-[#A8E6A1]"
          >
            Shop hardware
          </Link>
        </div>
