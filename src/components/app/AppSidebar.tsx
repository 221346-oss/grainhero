...
const workspaceNav: NavItem[] = [
  ...
  },
  {
    ...
    icon: CreditCard,
    roles: ["admin", "manager"],
    marqueeItems: ["My Plan", "Usage", "Billing", "Upgrade"],
  },
  // /business is tenant-scoped (invoices, own subscription) — admin and manager only.
  {
    ...
    icon: Briefcase,
    roles: ["admin", "manager"],
    marqueeItems: ["Revenue", "Subscription"],
  },
...
const globalTechnicianNav: NavItem[] = [
  {
    ...
    icon: Package,
    roles: ["technician"],
    marqueeItems: ["Assigned", "In Progress", "Completed"],
  },
];
...
const tenantTechnicianNav: NavItem[] = [
  {
    ...
    icon: Wrench,
    roles: ["technician"],
    marqueeItems: ["Status", "Availability"],
  },
  {
    name: "sensors",
    label: "Sensors",
    ...
    icon: Radio,
    roles: ["technician"],
    marqueeItems: ["Online", "Offline", "Readings"],
  },
  {
    name: "actuators",
    label: "Actuators",
...
const utilityNav: NavItem[] = [
  {
    ...
    icon: CreditCard,
    roles: ["super_admin"],
    marqueeItems: ["Edit limits", "Active/inactive", "Popular badge", "Change requests"],
  },
  {
    ...
    icon: Briefcase,
    roles: ["super_admin"],
    marqueeItems: ["Revenue", "Subscriptions", "Hardware", "Install Orders"],
  },
  {
    ...
    icon: Activity,
    roles: ["super_admin"],
    marqueeItems: ["Incidents", "Environmental", "Maintenance"],
  },
  {
    name: "platform-silo-requests",
    label: "Silo Requests",
    to: "/platform/silo-requests",
    icon: Inbox,
    roles: ["super_admin"],
    marqueeItems: ["Pending review", "Approved", "Rejected", "All requests"],
  },
  {
    name: "platform",
    label: "Platform",
