...
export function ManagerKpiSummary({
  ...
  const rows = [
    { label: "Active batches", value: k?.batchesActive ?? "—", to: "/grain-operations" },
    { label: "QC pending", value: k?.qcPending ?? "—", to: "/grain-operations" },
    { label: "Ready to dispatch", value: k?.dispatchReady ?? "—", to: "/grain-operations" },
