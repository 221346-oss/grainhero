...
export function KpiSummary({
  ...
  const rows: Row[] = [
    { label: "Buyers", value: s?.buyers ?? "—", to: "/grain-operations" },
    { label: "Warehouses", value: s?.warehouses ?? "—", to: "/grain-operations" },
    { label: "Active Batches", value: s?.batches.active ?? "—", to: "/grain-operations", delta: deltaBatches },
    { label: "Silos", value: s?.silos ?? "—", to: "/grain-operations" },
