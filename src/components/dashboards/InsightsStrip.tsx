...
import { AlertTriangle, PauseCircle, AlertOctagon } from "lucide-react";
        ...
        {tiles.map((t) => {
          return (
            <Link
              ...
              className="rounded-lg bg-card px-3 py-2.5 transition hover:ring-1 hover:ring-emerald-500/40"
            >
